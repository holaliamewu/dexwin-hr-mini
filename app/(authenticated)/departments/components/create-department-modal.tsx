...
export default function CreateDepartmentModal({open, onClose}:TModalProps) {
    ...
    return(
        <section className="flex flex-col items-center justify-center absolute w-screen h-full top-0 left-0 bg-black/70 z-100" >
            <div className="relative min-w-[640px] h-fit bg-white p-6 rounded-xl" >
                <h1 className="text-[20px] font-bold" >Create your department</h1>
                <p className="text-[14px] text-[#71717a]  " >Enter department name and description to create department</p>
